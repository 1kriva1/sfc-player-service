...
//        // Assert
//        _mediatorMock.Verify(m => m.Publish(It.IsAny<PlayersRetrievedEvent>(), It.IsAny<CancellationToken>()), Times.Never);
//    }
...
//        // Assert
//        _mediatorMock.Verify(m => m.Publish(It.IsAny<PlayersRetrievedEvent>(), It.IsAny<CancellationToken>()), Times.Once);
//    }
//}
