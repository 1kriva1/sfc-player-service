...
{
    private readonly Mock<ILogger<GetPlayersEvent>> _loggerMock = new();
    ...
    public async Task Feature_Notification_Players_ShouldSetCacheValues()
    {
        ...
        GetPlayersEvent @event = new(new List<PlayerEntity> { new() { Id = 0 }, new() { Id = 1 } });
        ...
        GetPlayersNotificationHandler handler = new(_loggerMock.Object, _cacheMock.Object, _cacheSettingsMock.Object);
