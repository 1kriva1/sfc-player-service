...
//        client.DefaultRequestHeaders.Add(HeaderNames.AcceptLanguage, CommonConstants.SUPPORTED_CULTURES[1]);
...
//        Assert.False(responseValue.Success);
//        Assert.Equal(Localization.PlayerNotFound, responseValue.Message);
//    }
