...
//        OwnPlayerHandler handler = new(_mockPlayerRepository.Object, httpContextAccessor.Object, userServiceMock.Object);
...
//        Mock<IHttpContextAccessor> httpContextAccessor = BuildHttpContextAccessorMock(httpContext);
//        _mockPlayerRepository.Setup(r => r.AnyAsync(long.Parse(resoureIdValue), nameIdentifierClaimValue)).ReturnsAsync(false);
//        Mock<IUserService> userServiceMock = new();
//        OwnPlayerHandler handler = new(_mockPlayerRepository.Object, httpContextAccessor.Object, userServiceMock.Object);
...
//        httpContext.User = principal;
//        Mock<IHttpContextAccessor> httpContextAccessor = BuildHttpContextAccessorMock(httpContext);
//        _mockPlayerRepository.Setup(r => r.AnyAsync(long.Parse(resoureIdValue), nameIdentifierClaimValue)).ReturnsAsync(true);
//        Mock<IUserService> userServiceMock = new();
//        OwnPlayerHandler handler = new(_mockPlayerRepository.Object, httpContextAccessor.Object, userServiceMock.Object);
//        AuthorizationHandlerContext authorizationContext = new([new OwnPlayerRequirement()], principal, null);
