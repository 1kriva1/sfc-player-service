...
//        await context.Set<PlayerEntity>().AddAsync(new PlayerEntity
//        {
//            Id = playerId,
...
//        // Assert
//        PlayerEntity player = (await context.Players.Where(player=>player.Id == playerId).FirstAsync())!;
...
//        context.Set<PlayerEntity>().Update(player);
//        await context.SaveChangesAsync();

//        // Assert
//        PlayerEntity assertPlayer = (await context.Players.Where(player => player.Id == playerId).FirstAsync())!;
