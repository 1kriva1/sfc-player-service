...
//    {
//        // Arrange
//        CacheRepository<PlayerGeneralProfile, PlayerDbContext, long> repository = CreateRepository();
...
//    [Fact]
//    [Trait("Persistence", "Repository")]
//    public async Task Persistence_CacheRepository_ShouldFind()
//    {
//        // Arrange
//        CacheRepository<PlayerGeneralProfile, PlayerDbContext, long> repository = CreateRepository();
//        PlayerGeneralProfile entityFirst = new()
...
//    private CacheRepository<PlayerGeneralProfile, PlayerDbContext, long> CreateRepository()
//    {
...
//        return new CacheRepository<PlayerGeneralProfile, PlayerDbContext, long>(new Repository<PlayerGeneralProfile, PlayerDbContext, long>(context), _cacheMock.Object);
//    }
//}
